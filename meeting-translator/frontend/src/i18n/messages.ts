...
const vi = {
  ...
  exportModalHint: "Chọn thư mục lưu và định dạng file.",
  exportSaveFolder: "Thư mục lưu",
  exportFormat: "Định dạng",
  exportConfirm: "Xuất",
  exportAsTxt: "Văn bản (.txt)",
  exportAsVideo: "Video (.mp4 / .webm)",
  exportNeedDir: "Chọn thư mục lưu",
...
const ja: Record<MessageKey, string> = {
  ...
  starting: "開始中…",
  exportData: "データ出力",
  exportModalHint: "保存フォルダとファイル形式を選んでください。",
  exportSaveFolder: "保存フォルダ",
  exportFormat: "形式",
  exportConfirm: "出力",
  exportAsTxt: "テキスト (.txt)",
  exportAsVideo: "動画 (.mp4 / .webm)",
  exportNeedDir: "保存フォルダを選択してください",
