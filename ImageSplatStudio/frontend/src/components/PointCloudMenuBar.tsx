...
export function PointCloudMenuBar({
  ...
  return (
    <nav className={`pc-menu-bar ${compact ? "pc-menu-bar-compact" : ""}`} aria-label={tr("pcMenuLabel")}>
      {!meshOnly && (
        <>
          <div className="pc-menu-group">
            {!compact && <span className="pc-menu-label">{tr("pcMenuFile")}</span>}
            <button
              type="button"
          ...
          <div className="pc-menu-group">
            {!compact && <span className="pc-menu-label">{tr("pcMenuEdit")}</span>}
            <button
              type="button"
              className="pc-menu-btn"
              disabled={disabled}
          ...
          <div className="pc-menu-group">
            {!compact && <span className="pc-menu-label">{tr("pcMenuFilter")}</span>}
            <button
              type="button"
              className="pc-menu-btn"
              disabled={disabled}
          ...
          <div className="pc-menu-group">
            {!compact && <span className="pc-menu-label">{tr("pcMenuTools")}</span>}
            <button
              type="button"
              className="pc-menu-btn"
              disabled={disabled}
      ...
      <div className="pc-menu-group">
        {!compact && <span className="pc-menu-label">{tr("pcMenuMesh")}</span>}
        <button
          type="button"
