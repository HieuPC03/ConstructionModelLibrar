...
const translations = {
  vi: {
    ...
    pcDesc:
      "Chuyển point cloud thành mô hình 3D Gaussian Splatting — hiển thị mượt như Luma AI. Hỗ trợ PLY từ Luma/Polycam.",
    ...
    noPcFile: "Chưa chọn file (.ply, .pcd, .xyz, .las, .laz...)",
  ...
  ja: {
    ...
    pcTitle: "点群 → 3Dボリューム",
    pcDesc:
      "点群を3D Gaussian Splattingモデルに変換 — Luma AIのような滑らかな表示。Luma/PolycamのPLYに対応。",
    ...
    chooseFile: "ファイルを選択",
    noPcFile: "未選択 (.ply, .pcd, .xyz, .las, .laz...)",
    pcDemo: "デモ（サンプル点群を使用）",
    pcSubmit: "3Dボリュームを作成",
    pcSubmitting: "処理中...",
    remove: "削除",
